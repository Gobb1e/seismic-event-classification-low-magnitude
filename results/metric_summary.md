...
- Macro-averaged metrics highlight the substantial performance gap between
  ensemble / margin-based methods and linear classifiers.
- Random Forest and SVM consistently outperform other models across all macro
  metrics, confirming their suitability for automated seismic catalogue maintenance.
- Lower Macro-F1 scores in LDA and Radius NN indicate reduced sensitivity to rare
  seismic event types.
